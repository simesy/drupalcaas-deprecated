...
// Overrides settings dynamically on any environment.
if (file_exists($app_root . '/' . $site_path . '/override.settings.php')) {
  include_once $app_root . '/' . $site_path . '/override.settings.php';
}
